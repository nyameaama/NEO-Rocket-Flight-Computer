#include"Path.h"
    ...
    //Convert 2D array to 1D array    
		...
		double PathCompute::alt_PathController(double cLoc,uint8_t haslaunched){
			if(haslaunched == 1){
		...
		double *PathCompute::pathController(double latC,double longC,double alt,double *xF_pathData[64][2]){
